...
<section class="container mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
        ...
        <tbody class="divide-y divide-gray-200 bg-white">
            ...
            <tr>
                ...
                <td class="p-4 text-sm text-gray-600">
                    ...
                    <div class="inline-block relative cursor-pointer">
                        <a href="/transaction/<?php echo $transaction['id'];?>/receipt/<?php echo $receipt['id'];?>">
                        ...
                        <form
                            action="/transaction/<?php echo $transaction['id'];?>/receipt/<?php echo $receipt['id'];?>"
                            method="POST">
                ...
                <td class="p-4 text-sm text-gray-600 flex justify-center space-x-2">
                    ...
                    <a href="/transaction/<?php echo $transaction['id'];?>"
    ...
    <nav class="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0 mt-6">
        ...
        <div class="-mt-px flex w-0 flex-1">
            ...
            <a href="/advanced_search?<?php echo $previousPageQuery;?>"
        ...
        <div class="hidden md:-mt-px md:flex">
            ...
            <a href="/advanced_search?<?php echo $query;?>"
        ...
        <div class="-mt-px flex w-0 flex-1 justify-end">
            ...
            <a href="/advanced_search?<?php echo $nextPageQuery;?>"
